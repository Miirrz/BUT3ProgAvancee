...
class Produit
{
    ...
    #[ORM\Column(enumType: ProduitStatut::class)]
    private ?ProduitStatut $statut = null;
    ...
    public function getStatut(): ?ProduitStatut
    {
        return $this->statut;
    }

    public function setStatut(ProduitStatut $statut): static
    {
        $this->statut = $statut;
